...
* Authorization Code: The [Authorization Code Grant]({{ page.am_release_version}}/oauth2-guide/#oauth2-authz) is a two-step interactive process used when the client, such as a Java application running on a server, requires access to protected resources.  
